...
void RModel::MarkedChecked(std::string tensor_name, std::size_t size){
...
void RModel::AddIntermediateTensor(std::string tensor_name, ETensorType type, std::vector<Dim> dim_shape) {
   ...
   MarkedChecked(tensor_name, ConvertShapeToLength(dim_shape));
}
...
void RModel::AddIntermediateInputTensorCount(std::string tensor_name){
   fIntermediateInputTensorLookup[tensor_name]++;
}
